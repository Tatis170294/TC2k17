      ...
      <div class="row">
        <div class="col-md-12 panel-info">
          ...
          <div class="content-box-large box-with-header">
            <form method="post" action="<?php echo base_url();?>usuario/insert_post/<?php echo $Matricula;?>">
              <div class="row">
                <div class="col-sm-3">
                  <label>Matrícula</label>
                  <input type="text" class="form-control" name="matricula" required="required" value="<?php echo $Matricula;?>">
                </div>
                <div class="col-sm-3">
                  <label>Nombre</label>
                ...
                <div class="col-sm-3">
                  <label>Correo</label>
                  <input type="email" class="form-control" name="correo" required="required" value="<?php echo $Correo;?>">
                </div>
                <div class="col-sm-3">
